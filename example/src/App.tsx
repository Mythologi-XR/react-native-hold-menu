...
import Clubhouse, { ClubhouseNavButtonLeft, ClubhouseNavButtonRight } from './screens/Clubhouse'
        ...
        <HoldMenuProvider
          ...
          <NavigationContainer>
            <Stack.Navigator
              ...
              />
              <Stack.Screen name="Playground" options={{ ...headerOptions }} component={Playground} />
              <Stack.Screen name="Whatsapp" options={{ ...headerOptions }} component={Whatsapp} />
              <Stack.Screen name="Telegram" options={{ ...headerOptions }} component={Telegram} />
              <Stack.Screen
                name="Clubhouse"
