...
<Video title="React Native Bottom Sheet" url={useBaseUrl('video/hold-menu-preview.mp4')} />
...
```bash
yarn add react-native-reanimated@2.1.0 react-native-gesture-handler react-native-unimodules @react-native-community/blur expo-haptics
```
